 ...
 * @author miguel
 */
public class StationOneRemote extends UnicastRemoteObject implements RMIConnector.RMIConnector{
    StationControl stationControl;
    
    public StationOneRemote(StationControl stationControl) throws RemoteException {
